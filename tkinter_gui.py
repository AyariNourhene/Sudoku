...
class SudokuGUI:
    ...
    def create_widgets(self):
        ...
        ttk.Label(self.result_frame, text="Temps d'exécution:").grid(row=2, column=0, sticky=tk.W)
        self.execution_time_label = ttk.Label(self.result_frame, text="0.000 sec")
        self.execution_time_label.grid(row=2, column=1, sticky=tk.W)
    ...
    def solve(self):
        ...
        if solution:
            self.display_grid(solution)
            self.execution_time_label.config(text=f"{execution_time:.3f} sec")
        else:
            messagebox.showinfo("Information", "La résolution a échoué")
    ...
    def clear_results(self):
        ...
        self.iterations_label.config(text="0")
        self.conflicts_label.config(text="0")
        self.execution_time_label.config(text="0.000 sec")
